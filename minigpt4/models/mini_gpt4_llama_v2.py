...
class MiniGPT4_llama_v2(Blip2Base):
    ...
    def __init__(
        ...
        login(token = "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")
        self.llama_tokenizer = LlamaTokenizer.from_pretrained(llama_model,use_fast=False, token="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")  #
    ...
    def generate(
        ...
        if return_video_temporal_features:
            ...
            return answers[0], float(np.sum(np.exp(transition_scores.numpy())))
